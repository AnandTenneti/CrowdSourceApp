...
public class UserTaskstest extends BaseTest {
    ...
    public void TC_4() throws Exception {
        ...
        imageCategoriesPage.searchForImageCategory("mountain");
    ...
    public void TC_9() throws Exception {
        ...
        Thread.sleep(1000);
        leaderBoardsPage.clickOnContributionsInCategories("Smart Camera");
        Thread.sleep(5000);
